...
import 'package:fitness_health_ui/view/home_screen/help_and_support.dart';
import 'package:fitness_health_ui/view/home_screen/terms_and_conditions.dart';
import 'package:fitness_health_ui/view/login_screen/login_view.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    Color BMIColor = isDarkMode ? Colors.white : TColo.white;
    Color subtitletextColor = isDarkMode ? TColo.white.withOpacity(0.7) : TColo.white.withOpacity(0.7);
    final lineBarsData = [
      LineChartBarData(
            ...
            DrawerHeader(
              decoration: BoxDecoration(
               ...
               child: Column(
                 children: [
                   CircleAvatar(
                     backgroundImage: AssetImage("assets/img/app_logo.png"),
                     backgroundColor: Colors.green,
                     radius: 46,
                   ),
                   Padding(
                     padding: const EdgeInsets.only(top: 10),
                     child: Text("Mindful Hub", style: GoogleFonts.poppins(
                       fontSize: 22,
                                      ...
                                      ShaderMask(
                                        ...
                                        shaderCallback: (bounds) {
                                          return LinearGradient(
                                              colors: TColo.primaryG,
                                              begin: Alignment.centerLeft,
                                              end: Alignment.centerRight).createShader(Rect.fromLTRB(
                                              0, 0, bounds.width, bounds.height));
                                        },
                                        child: Text(
                                          "4 Liters",
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    height: 10,
                                                    decoration: BoxDecoration(
                                                      color: TColo.secondaryColor1.withOpacity(0.5),
                                                      borderRadius: BorderRadius.circular(5),
                                                    ),
                                                  ),
                                                  if (!isLast)
                                                    DottedDashedLine(height: media.width * 0.078, width: 0,
                                                        dashColor: TColo.secondaryColor1.withOpacity(0.5), axis: Axis.vertical)
                                                ],
                                              ),
                                              const SizedBox(
                                                width: 10,
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton(
                              items: ["Weekly", "Monthly"]
                                ...
                                child: Text(
                                  name,
                                  style: GoogleFonts.poppins( color: TColo.grey, fontSize: 14)
                                ),
                              )).toList(),
                              onChanged: (value) {},
  ...
  List<PieChartSectionData> showingSections() {
    return List.generate(2, (i) {
        var color0 = TColo.secondaryColor1;
        switch (i) {
          case 0:
