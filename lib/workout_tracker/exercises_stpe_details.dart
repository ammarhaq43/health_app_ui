              ...
              SizedBox(
                ...
                child: CupertinoPicker.builder(
                  ...
                  selectionOverlay: Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border(
                        top: BorderSide(color: TColo.grey.withOpacity(0.2), width: 1),
                        bottom: BorderSide(
                            color: TColo.grey.withOpacity(0.2), width: 1),
                      ),
                    ),
                  ),
                    ...
                    return Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(color: TColo.grey, fontSize: 10),
                        ),
                        Text(
                          " ${index + 1} ",
                          style: TextStyle(
                        ...
                        Text(
                          " times",
                          style: TextStyle(color: TColo.grey, fontSize: 16),
                        )
                      ],
                    );
                  },
