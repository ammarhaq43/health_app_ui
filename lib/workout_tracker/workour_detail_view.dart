import 'package:fitness_health_ui/workout_tracker/workout_schedule_view.dart';
...
class _WorkoutDetailViewState extends State<WorkoutDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration:
      BoxDecoration(gradient: LinearGradient(colors: TColo.primaryG)),
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        height: 4,
                        decoration: BoxDecoration(
                            color: TColo.grey.withOpacity(0.3),
                      ...
                      IconTitleNextRow(
                          ...
                          title: "Difficulity",
                          time: "Beginner",
                          color: TColo.secondaryColor2.withOpacity(0.3),
                          onPressed: () {}),
                      SizedBox(
                        height: media.width * 0.05,
                      ),
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            child: Text(
                              "${youArr.length} Items",
                              style:
                              TextStyle(color: TColo.grey, fontSize: 12),
                            ),
                          )
                        ],
                      ),
